...
El PDF compilado (83 páginas) está incluido: [`Notas de Álgebra Lineal.pdf`](<Notas de Álgebra Lineal.pdf>).
...
```bash
lualatex "Notas de Álgebra Lineal.tex"   # dos pasadas para resolver referencias
lualatex "Notas de Álgebra Lineal.tex"
```
